//
// dualsense_test — redirection shim to unified pcsx5_cli --test-input CLI (D3.4).
//
...
int main(int argc, char** argv) {
    ...
    std::printf("==================================================\n");
    std::printf("  pcsx5 - Standalone Input Tester Redirect\n");
    std::printf("==================================================\n");
    std::printf("[NOTICE] 'dualsense_test' has been deprecated in favor of the unified input tester.\n");
