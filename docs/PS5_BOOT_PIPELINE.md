...
6. **PRX Initialization:** The Kernel iterates the dependency graph in topological order, executing `DT_INIT` and `DT_INIT_ARRAY` for each PRX on the guest stack. *(CURRENT BOTTLENECK - libc.prx DT_INIT crashes with 0xa0020013)*
